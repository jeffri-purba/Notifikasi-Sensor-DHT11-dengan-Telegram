...
char ssid[] = "PURBA";     // diisi nama wifi
char password[] = "bet03kom"; // diisi password wifi

// Initialize Telegram BOT
#define BOTtoken "1458895911:AAGcF737Tc9e0zmcRcXsJkDSHbfhosSDh4g" // diisi Token Bot (Dapat dari Telegram Botfather)
